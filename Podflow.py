...
<!-- {{{output_dir}}} -->'''
    ...
    write_log(f"{channelid_youtube_ids[output_dir]} 播客{update_text}", f"地址: {config['url']}/channel_rss/{output_dir}.xml", channelid_youtube[channelid_youtube_ids[output_dir]]['DisplayRSSaddress'])
    return items
